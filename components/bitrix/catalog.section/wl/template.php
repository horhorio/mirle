...
if(empty($arResult[ITEMS])){
	echo "<div class='alert_warning margin-15'>К сожалению, Ваш список избранных товаров пуст, <a href='".MAIN_URL_CATALOG."'>Выбрать</a></div>";
}else{
foreach($arResult[ITEMS] as $arElement){
?>
<div class='col-lg-3 col-md-3 col-sm-4 col-xs-6' id="el_<?=$arElement[ID]?>">
	<div class="product shadow">
		...
		<div class="product-bg">
            ...
            <div class="btn-box">
				...
				?>
                <div class="not-available del">
					<a href="javascript:void(0);" rel="nofollow" title="Мне больше не нравится этот товар, пожалуй удалю" id="btn-av-<?=$arElement[ID]?>" onClick='elementFavoritesDel(<?=$arElement[ID]?>)'>Удалить</a>
				</div>
			</div>
		</div>
	</div>
