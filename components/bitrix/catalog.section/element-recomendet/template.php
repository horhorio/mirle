...
<div class="slick">
	<div class="wrapp">
    <h3 class="h3-head"><span class="before"></span>С этим товаром покупают<span class="after"></span></h3>
    </div>
    <div class="goods wrapp" id="carousel-new">
        <?
                ...
                <div class="product-bg">
                    <div class="product-img">
                        ...
                        if(($arElement[PREVIEW_PICTURE][SRC])AND(is_file($_SERVER["DOCUMENT_ROOT"].$arElement[PREVIEW_PICTURE][SRC]))){
							...
							echo"<img src='".DOMAIN.$arElement[PREVIEW_PICTURE][SRC]."' alt='".str_replace('quot', "", preg_replace('/[^а-яa-z0-9-\s]/ui', '', $arElement[PREVIEW_PICTURE][ALT]))."' class='responsive-img".$grayscale."'/>";
                        }else{
