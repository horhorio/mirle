...
<div class="slick">
	<div class="wrapp">
    <h3 class="h3-head"><span class="before"></span>Просмотренные товары<span class="after"></span></h3>
    </div>
                ...
                <div class="product-bg">
                    <div class="product-img">
                        ...
                        if(($arElement[PREVIEW_PICTURE])AND(is_file($_SERVER["DOCUMENT_ROOT"].$PREVIEW_PICTURE))){
							...
							echo"<img src='".DOMAIN.$PREVIEW_PICTURE."' alt='".str_replace('quot', "", preg_replace('/[^а-яa-z0-9-\s]/ui', '', $arElement[NAME]))."' class='responsive-img".$grayscale."'/>";
                        }else{
